...
const AboutYourLife = () => {
  return (
    <div className="lg:-mt-52 z-30 mb-18 bg-[#444142] lg:bg-transparent  h-auto sm:h-520 lg:h-260 xl:h-250 2xl:h-290 relative">
      <section className="bg-[#747676] px-4 rounded-tl-[3.5rem] lg:rounded-tl-[5rem] xl:rounded-tl-[7rem] 2xl:rounded-tl-[9rem] overflow-hidden relative w-full h-full ">
        <div
          ...
          <div className="h-full container mx-auto">
            <div className="flex flex-col items-center md:justify-center h-full w-full mt-18  lg:mt-0">
              ...
              <p className="text-center text-smallersubheading text-white max-w-4xl 2xl:max-w-6xl pb-40 sm:pb-0">
                ...
                golden handcuffs of large institutions or by the ceilings
                they’ve built for themselves. His financial advisor coaching
                helps them reignite their businesses and take ownership of their
                future.
              </p>
            </div>
          </div>
