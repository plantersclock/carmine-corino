...
const Hero = () => {
  return (
    <section className="relative z-20 w-full lg:h-230 xl:h-270 2xl:h-420 max-h-[110vh]">
      <Image
        src={heroImage}
        alt="Hero background"
        fill
        ...
        <div className="grid grid-cols-2 w-full">
          ...
          <div className="mx-auto w-full max-w-3xl lg:pl-12 xl:pl-22">
            ...
            <p className="my-8 max-w-md 2xl:max-w-2xl text-body text-white/90">
              Helping independent advisors create businesses that protect their
              time, their families, and their future.
            </p>
