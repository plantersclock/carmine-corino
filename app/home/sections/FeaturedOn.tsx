...
const FeaturedOn = () => {
  return (
    <section className="relative w-full h-110 sm:h-140 lg:h-180 2xl:h-210  rounded-tl-[3.75rem] lg:rounded-tl-[5rem] xl:rounded-tl-[7rem] 2xl:rounded-tl-[9rem] -mt-30 2xl:-mt-35 z-30 bg-white">
      <div className=" h-[80%] container mx-auto">
        <h2 className="text-heading pt-12 sm:pt-24 lg:pt-24 2xl:pt-32 text-center">
          Featured On
        </h2>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-18 lg:gap-0 2xl:gap-0 mt-12 sm:mt-18 2xl:mt-24 items-center container mx-auto px-6 scale-[.7] lg:scale-[.95]  xl:scale-[0.95] 2xl:scale-100 origin-top">
